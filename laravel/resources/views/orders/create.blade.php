        ...
        <form action="{{ route('orders.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                @if(isset($selectedClient))
                    <input type="text" class="form-control" value="{{ $selectedClient->name }}" disabled>
                ...
                @enderror
                @if(!isset($selectedClient))
                    <div class="form-text">Убедитесь, что у клиента есть bluesales_id для синхронизации</div>
                @endif
            </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select @error('user_id') is-invalid @enderror" id="user_id" name="user_id">
                    <option value="">Выберите сотрудника (по умолчанию - вы)</option>
            ...
            <div class="mb-4">
                ...
                <div id="order-items-container">
                    @php
                        $oldItems = old('order_items', [['product_name' => '', 'price' => '', 'quantity' => 1]]);
                        if (empty($oldItems)) {
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function formatNumber(value) {
                ...
                num = num.replace(',', '.');
                // Убираем все символы кроме цифр и одной точки
                num = num.replace(/[^\d.]/g, '');
            ...
            document.querySelector('form').addEventListener('submit', function(e) {
                // Убираем пробелы из всех полей цены

...
class UpdateOrderRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        // Убираем пробелы из prepay
        if ($this->has('prepay') && is_string($this->prepay)) {
            $this->merge([
                'prepay' => str_replace(' ', '', $this->prepay)
            ]);
        }
    ...
    {
        return [
            'bluesales_id' => 'nullable|string|unique:orders,bluesales_id,' . $this->route('order')->id,
